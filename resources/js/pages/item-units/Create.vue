...
<template>
  <Head title="Create Item Unit" />
  <AppLayout :breadcrumbs="[{ title: 'Item Units', href: '/item-units' }, { title: 'Create', href: '/item-units/create' }]">
    <div class="mx-auto max-w-2xl p-4">
      <div class="mb-6 flex items-center justify-between">
        <h1 class="text-2xl font-semibold">Create Item Unit</h1>
